...
{
    spdap::arg_parser ap("down_mangatown", "Download manga scans using mangatown.com");
    ...
    ap.add_gplv3_version_arg({"--version"}, "Output version information and exit", "1.0.0", "2018",
                             "Killian Poulaud");
    ap.add_keyless_arg("URI", "URI", "", {spdap::avt_t::STRING}, 1, 1,
                       spdap::af_t::DEFAULT_KEYLESS_ARG_FLAGS, {".+"});
    ap.add_help_text("");
